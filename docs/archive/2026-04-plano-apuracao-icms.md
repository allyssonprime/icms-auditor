...
>
> Todas as 9 fases foram executadas:
> - **Fase 1 (Parser enriquecido)**: `vFrete/vSeg/vDesc/vOutro/totais` em [`src/types/nfe.ts`](../../src/types/nfe.ts).
> - **Fase 2 (Validação BC)**: [`src/engine/bcValidation.ts`](../../src/engine/bcValidation.ts).
> - **Fase 3 (Validação CP)**: [`src/engine/cpValidation.ts`](../../src/engine/cpValidation.ts).
> - **Fase 4 (InfCpl)**: [`src/engine/infCplValidation.ts`](../../src/engine/infCplValidation.ts).
> - **Fase 5 (Apuração mensal)**: [`apuracao.ts`](../../src/engine/apuracao.ts), [`apuracaoTTD.ts`](../../src/engine/apuracaoTTD.ts), [`fundosTTD.ts`](../../src/engine/fundosTTD.ts).
> - **Fase 6 (Reconciliação DIME/SPED)**: [`reconciliacao.ts`](../../src/engine/reconciliacao.ts), [`efdParser.ts`](../../src/engine/efdParser.ts).
> - **Fase 7 (UI Confrontação Contábil)**: inputs em [`ReconciliacaoPanel.tsx`](../../src/components/ReconciliacaoPanel.tsx).
> - **Fase 8 (Planilha 7.7/7.8)**: `exportPlanilha77` em [`src/utils/exportExcel.ts`](../../src/utils/exportExcel.ts).
> - **Fase 9 (Cross-checks + B2-Industrial)**: em [`src/data/defaultRegras.ts`](../../src/data/defaultRegras.ts) e [`crossValidator.ts`](../../src/engine/crossValidator.ts).
>
> Fonte de verdade viva: [`RESUMO-COMPLETO-REGRAS-NEGOCIO.md`](../../RESUMO-COMPLETO-REGRAS-NEGOCIO.md).
